{{-- resources/views/meja/edit.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-purple-600">Edit Meja</h1>
        ...
        <form action="{{ route('meja.update', $meja->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="minimum_spent" id="minimum_spent" 
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-purple-500 focus:border-purple-500">
                    <option value="100000" {{ $meja->minimum_spent == 100000 ? 'selected' : '' }}>Rp 100.000</option>
                    <option value="200000" {{ $meja->minimum_spent == 200000 ? 'selected' : '' }}>Rp 200.000</option>
                    <option value="300000" {{ $meja->minimum_spent == 300000 ? 'selected' : '' }}>Rp 300.000</option>
                    <option value="400000" {{ $meja->minimum_spent == 400000 ? 'selected' : '' }}>Rp 400.000</option>
                </select>
            </div>
